...
public class Message implements Comparable<Message> {
     ...
     */
    private int initTtl;
    /*Ini aku nambah untuk kebutuhan Urgensi dan Security*/
    private int urgency;
     ...
     * @param id Message identifier (must be unique for message but will be the
    ...
    /*Dari bari ini sampai beris yang aku tandai, itu aku nambah sendiri*/
    public int getUrgency() {
//        return urgency;
        Random random = new Random();
        return this.urgency = random.nextInt(50) + 1;
...
//        return security;
        Random random = new Random();
        return this.security = random.nextInt(50) + 1;
    }
    ...
    public int getPriority() {
        int priority;
        priority = (this.getSecurity() + this.getUrgency()) / 2;
        return priority;
    }
