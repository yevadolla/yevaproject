...
public abstract class MessageRouter {
     ...
     */
    protected int sendQueueMode; //ini aku ubah dari private ke protected karena dikelas EpidemicROuterFMSD jadi error bagian sendQoeu
    protected int dropQueueMode;
    /**
    ...
    public MessageRouter(Settings s) {
        ...
        if (s.contains(SEND_QUEUE_MODE_S)) {
            ...
            sendQueueMode = Q_MODE_FIFO; //mengubah urutan pengiriman
        }
